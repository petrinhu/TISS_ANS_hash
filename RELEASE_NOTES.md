...
- **C# / .NET (NuGet)**: `dotnet add package TissHash`, publicado em [nuget.org/packages/TissHash](https://www.nuget.org/packages/TissHash).
...
- **Demais registries** (Maven Central, pub.dev, e npm para o WASM): em preparação; workflows prontos, ver [`docs/RELEASING.md`](docs/RELEASING.md). Por enquanto, instalar esses ports a partir do checkout (ver [`docs/USAGE.md`](docs/USAGE.md)).
