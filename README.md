...
- 2026-05-30: Dart publicado no pub.dev (`dart pub add tiss_hash`). Java publicado no Maven Central (`io.github.petrinhu:tiss-hash:0.1.0`). Kotlin publicado no Maven Central (`io.github.petrinhu:tiss-hash-kotlin:0.1.0`). Total: **9 registries canonicos** no ar (PyPI, npm, crates.io, Packagist, NuGet, pkg.go.dev, pub.dev, Maven Central x2). Sem mudanca no algoritmo.
