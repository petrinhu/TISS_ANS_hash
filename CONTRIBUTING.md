...
O projeto vive no GitHub: [`petrinhu/TISS_ANS_hash`](https://github.com/petrinhu/TISS_ANS_hash).

- **Abrir issues** no GitHub. O mantenedor monitora por lá.
- **Abrir PRs** no GitHub.
...
| `ci`       | Mudança em CI (workflows GitHub Actions).                      |
