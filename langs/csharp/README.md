...
nos **15 vetores** de conformidade compartilhados em
`conformance/vectors.json`.

- **Status:** alpha (15/15 vetores PASS)
- **TFM:** `net8.0` (LTS)
- **Licença:** MIT
...
2. Localizar o primeiro `<ans:hash>` (qualquer prefixo, namespace
...
- **Encoding ISO-8859-1:** registrado via
  ...
  embute code pages legacy por default.
...
Esperado: **22+ testes PASS** (15 vetores de conformidade + ~7 testes
de API/erro).
